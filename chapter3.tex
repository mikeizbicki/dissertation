...
\begin{lemma}
    Let $\set X=\R^d$ with the standard $L2$ distance function.
...
The doubling dimension is a more robust notion of dimension than the expansion dimension.
It is well studied in analysis where it is used to measure the dimensionality of fractals.
Compared with the expansion dimension, however, 
it has seen relatively little use in the design of data structures.
The only examples known to the author are \citet{clarkson1997nearest} and \citet{krauthgamer2004navigating}.
Despite this lack of data structures, the doubling dimension is widely studied in computer science.
Chapter 32 of \cite{toth2017handbook} provides a survey of how the doubling dimension is used in approximation algorithms for NP-hard problems,
and Chapter 27 of \cite{shalev2014understanding} shows how the doubling dimension is used to bound the generalization error of machine learning algorithms.
...
The duality between covering and packing motivates a novel definition of the 
...
\noindent
The doubling dimension, however, is more robust as shown in the following lemma.
...
\begin{proof}
    ...
    To prove \eqref{eq:doubnumplusone},
