...
%Model selection is the process whereby we select which machine learning algorithm to use.
%There are three main methods for model selection in machine learning:
%the validation set,
%the bootstrap,
%and cross validation.

%The empirical risk $\riskhat$ is a biased estimator of the true risk $\riskstar$.
