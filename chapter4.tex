...
a data structure for faster nearest neighbor queries in arbitrary metric spaces.
The cover tree was introduced by \cite{beygelzimer2006cover} and has seen widespread use in the machine learning community.
